...
<div id="wrap">
   ...
   &lt;%&ndash;            <a style="color: #cccccc; font-size: 13px; padding: 3px;" href="/othergroup" onClick="window.open(this.href, '', 'width=400, height=430'); return false;">-기타그룹 등록</a><br>&ndash;%&gt;
        ...
        <button type="button" onclick="existingSelectUp(this)" style="top:8%; border-style:none; background-color:#BDBDBD; position:fixed; left:735px; z-index: 20000; font-size:13px;  height:22px; font-family: nana; font-weight: bold; color:#ffffff;">기존 그룹</button>
        <button type="button" onclick="obstacleSelectUp(this)" style="top:8%; border-style:none; background-color:#BDBDBD; position:fixed; left:655px; z-index: 20000; font-size:13px; height:22px; font-family: nana; font-weight: bold; color:#ffffff;">장애 보고</button>
        <form id="frm" name="frm" method="POST" action="/send">
            ...
            <a style="left:435px; z-index: 20000; color:#000000; font-size:15px; position:fixed; top:8%; font-family: nana;">이름 검색</a>
            <input onkeyup="filter()" type="text" id="value" placeholder="name to Search" style=" position:fixed;  width:97px; top:8%; left:505px; z-index: 20000;">
            <a style="left:225px; z-index: 20000; color:#444444; font-size:15px; top:8%; font-family: nana;position:fixed; ">- 부서 선택</a>
            <select id="groupBox1" style=" left:305px; font-family:nana; position:fixed; z-index: 20000; top:8%; font-size:14px;">
...
<%--            <input type="button" tabindex="-1" value="전송하기" style="border-style:none; text-shadow:2px 2px 2px #BDBDBD;  background-color:white; color:#616c79; font-family: nana;  font-size:20px; position:fixed; left:1205px; top: 75.5%;"/>
            ...
            <input type="button" name="kakao1" id="kakao1" tabindex="-1" onclick="sendBoxHidden1()" value="운영보고 전송하기(오전)" style="border-style:none; border-width: 1px;   text-align:left; color:#000000; position:fixed; font-family:nana;  font-size:15px; width: 200px;  left: 89%; top: 84.5%;"/>
            <input type="button" name="kakao2" id="kakao2" tabindex="-1" onclick="sendBoxHidden2()" value="운영보고 전송하기(오후)" style="border-style:none; border-width: 1px; width: 200px; color:#000000; font-family: nana; position:fixed; left: 89%; font-size:15px; top: 88.5%; text-align:left;"/>
            ...
            <div id="sendBox1" style="position:fixed; border : solid 1px; padding: 20px;  left:710px;  top:16%; width: 710px; height: 450px;">
            ...
            <div id="sendBox2"  style="position: fixed; clear: both; border: 1px solid;  left:710px;  top:16%; width: 710px; height: 450px; padding: 20px; display: block;">
            ...
            <div id="sendBox3"  style="position: fixed; clear: both; border: 1px solid;  left:710px;  top:16%;  width: 710px; height: 450px; padding: 20px; display: block;">
