...
<div id="contents">
	...
	<form id="otherGroup" name="otherGroup" method="POST">
		<div id="conWrap">
			...
			<div style="border:0px solid; position:fixed; z-index: 103; top:9%; width: 18.5%; right:20.5%;" name="groupA"  >
				<a style="color:#444444; font-family:nana; font-size:20px; font-weight: bold;">기존 수신자</a><br><br>


				<div style="height:700px; overflow-y: scroll; width:650px; position:fixed;">
		...
		<div>
			...
			<div style="border:0px solid; position:fixed; z-index: 103; top:7%; width: 18.5%; left:1.5%;" name="groupA" id="groupA" >
				<a style="color:#444444; font-family:nana; font-size:20px; font-weight: bold;">기존 수신자 제외</a><br><br>

				<a style="color:slategray; font-family:nana;">전체 체크 </a>
				<input type="checkbox" tabindex="-1" id ="chkAll" name ="chkAll" onclick="chk_All();"/><br><br>


				<div style="height:700px; overflow-y: auto; width:630px; position:fixed;">
					<table style="font-family:nana; ">
